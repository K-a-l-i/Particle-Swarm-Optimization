...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep  4 12:31:15 2020
...
def Static(func,swarmsize=-1, omega=0.7, phip=1.4, phig=1.4, maxiter=2000, minstep=1e-8, minfunc=1e-8, debug=False, processes=1,particle_output=False):
    ...
    if cons and cons_eq:
        ...
        def pen(x):
            return penalty(cons,mag,x,l)+penalty(cons_eq,mag,x,l)
        ...
        def pen(x):
            return penalty(cons_eq,mag,x,l)
    ...
    l = 10 #a and b are integer constants and S is the penalty Multiplier
